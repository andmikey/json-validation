...
- HTTP responses:
  - OK: 200
    - Schema successfuly retrieved
    - Document successfuly validated against schema
  - Created: 201
    - Schema succesfully saved to database
  - Not found: 404
    - Could not retrieve schema: does not exist
  - Internal server error: 500
    - Document could not be validated against schema
    - Schema could not be saved to database
** Resources
